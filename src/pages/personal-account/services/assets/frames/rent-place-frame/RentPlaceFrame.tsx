...
import {RentTable} from '../../tables/ip-table/RentTable';
...
const RentPlaceFrame = (props: PropsType) => {
                ...
                state.map((el) => {
                    return (
                        <div className={s.wrap} key={el.id}>
                            ...
                            {!props.archive && <a href="/src/pages" className={s.more}>Подробнее</a>}
                        </div>
                    )
                })
                : <div className={s.wrap}>
                    <div className={s.row}>
                        <div className={`${s.top} ${s.zero}`}>
                            ...
                            <a href="/src/pages" className={s.link}>?</a>
                        </div>
